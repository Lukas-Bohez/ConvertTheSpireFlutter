...
try {
  ...
  Copy-Item -Force $builtAab 'aab\bitplayer-v12.2.1+1221-play-release.aab'
  Write-Host 'SUCCESS: aab\bitplayer-v12.2.1+1221-play-release.aab is signed with the expected key.'
} finally {
  Pop-Location
}
