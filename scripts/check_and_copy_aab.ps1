...
Copy-Item $aab -Destination "aab\\bitplayer-v12.2.1+1221-play-release.aab" -Force
Get-Item "aab\\bitplayer-v12.2.1+1221-play-release.aab" | Select-Object Name,@{N='MB';E={[math]::Round($_.Length/1MB,2)}} | Format-List
Write-Host "COPIED"
exit 0
