...
Copy-Item $aab -Destination "aab\\convert-the-spire-reborn-v12.1.4+1214-play-release.aab" -Force
Get-Item "aab\\convert-the-spire-reborn-v12.1.4+1214-play-release.aab" | Select-Object Name,@{N='MB';E={[math]::Round($_.Length/1MB,2)}} | Format-List
Write-Host "COPIED"
exit 0
