...
Copy-Item $src -Destination 'c:\development\ConversionFlutter\my_flutter_app\aab\bitplayer-v12.1.4+1214-play-release.aab' -Force
$it = Get-Item 'c:\development\ConversionFlutter\my_flutter_app\aab\bitplayer-v12.1.4+1214-play-release.aab'
