...
List<ColourReward> _manyCommonRewards() {
  return const [
    ...
    ColourReward(
        id: 'c3',
        displayName: 'Common 3',
        color: Color(0xFF263238),
        rarity: RarityTier.common),
    ColourReward(
        id: 'c4',
        displayName: 'Common 4',
        color: Color(0xFF90A4AE),
        rarity: RarityTier.common),
    ColourReward(
        id: 'c5',
        displayName: 'Common 5',
        color: Color(0xFF8A9BA7),
        rarity: RarityTier.common),
    ColourReward(
        id: 'c6',
        displayName: 'Common 6',
        color: Color(0xFF607D8B),
        rarity: RarityTier.common),
    ColourReward(
        id: 'c7',
        displayName: 'Common 7',
        color: Color(0xFF546E7A),
        rarity: RarityTier.common),
    ColourReward(
        id: 'c8',
        displayName: 'Common 8',
        color: Color(0xFF455A64),
        rarity: RarityTier.common),
    ColourReward(
        id: 'c9',
        displayName: 'Common 9',
        color: Color(0xFF37474F),
        rarity: RarityTier.common),
    ColourReward(
        id: 'c10',
        displayName: 'Common 10',
        color: Color(0xFF263238),
        rarity: RarityTier.common),
  ];
}
...
void main() {
  testWidgets(
      'Colour reward summary scrolls and keeps the claim button reachable',
