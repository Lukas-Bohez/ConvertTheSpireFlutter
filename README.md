...
* **[Latest GitHub Release (v14.1.0)](https://github.com/Lukas-Bohez/ConvertTheSpireFlutter/releases/latest)**: Get the full-featured app for Windows, macOS, and Android (APK). The GitHub APK builds are ad-free and unlock all colours by default.
...
* **Linux:** No longer distributed as of v14.1.0 (the build could not be kept reliable). The source is still in the repo if you want to build it yourself.
