...
const List<ColourReward> kAllColours = [
  ...
  ColourReward(
      id: 'indigo',
      displayName: 'Indigo',
      color: Color(0xFF3F1F8A),
      rarity: RarityTier.uncommon),
  ColourReward(
      id: 'burnt_sienna',
      displayName: 'Burnt Sienna',
      color: Color(0xFFBF4A00),
      rarity: RarityTier.uncommon),
  ColourReward(
      id: 'bark',
      displayName: 'Bark',
      color: Color(0xFF5D3526),
      rarity: RarityTier.uncommon),
  // Rare
  ...
  ColourReward(
      id: 'berry',
      displayName: 'Berry',
      color: Color(0xFF9C1850),
      rarity: RarityTier.rare),
  ColourReward(
      id: 'cyan_depth',
      displayName: 'Cyan Depth',
  ...
  ColourReward(
      id: 'dragon_teal',
      displayName: 'Dragon Teal',
      color: Color(0xFF007A7A),
      rarity: RarityTier.legendary),
  ColourReward(
      id: 'wine_crest',
      displayName: 'Wine Crest',
      color: Color(0xFF7B2C2C),
      rarity: RarityTier.legendary),
  // Mythic
  // Mythic — extreme contrast and uniqueness
  ColourReward(
      id: 'mythic_red',
      displayName: 'Mythic Red',
      color: Color(0xFFE53935),
      rarity: RarityTier.mythic),
  ColourReward(
      id: 'mango_passion',
      displayName: 'Mango Passion',
