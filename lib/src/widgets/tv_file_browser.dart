  ...
  if (Platform.isAndroid) {
    try {
      ...
      if (picked != null && picked.isNotEmpty) {
        // Persist last folder as the tree URI so future file operations use SAF.
        await FolderHistoryService().saveLastFolder(picked);
        return picked;
      }
    } catch (_) {
      // Fall through to built-in browser fallback below.
    }
  }
